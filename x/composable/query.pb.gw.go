...
var (
	pattern_Query_Balance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"lbm", "composable", "v1beta1", "balance", "owner", "classes", "class_id"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_Supply_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"lbm", "composable", "v1beta1", "classes", "class_id", "supply"}, "", runtime.AssumeColonVerbOpt(false)))
