...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"lbm", "composable", "v1beta1", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Class_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"lbm", "composable", "v1beta1", "classes", "class_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Classes_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"lbm", "composable", "v1beta1", "classes"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFT_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"lbm", "composable", "v1beta1", "classes", "class_id", "nfts", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFTs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"lbm", "composable", "v1beta1", "classes", "class_id", "nfts"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Owner_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7}, []string{"lbm", "composable", "v1beta1", "classes", "class_id", "nfts", "id", "owner"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Parent_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 2, 5, 1, 0, 4, 1, 5, 6, 2, 7}, []string{"lbm", "composable", "v1beta1", "classes", "class_id", "nfts", "id", "parent"}, "", runtime.AssumeColonVerbOpt(false)))
)
